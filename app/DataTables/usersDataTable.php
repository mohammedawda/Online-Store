...
class usersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.usersData.btn.checkbox')
            ->addColumn('edit', 'admin.usersData.btn.edit')
            ->addColumn('delete', 'admin.usersData.btn.delete')
            ->addColumn('level', 'admin.usersData.btn.level')
            ->rawColumns([
                'checkbox', 'edit', 'delete', 'level'
            ]);
    }
    ...
    */
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons'    =>[
                            ['className' => 'btn btn-info', 'text' => '<i class="fa fa-plus"> ' . trans('admin.createUser') . '</i>',
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name' => 'name', 'data' => 'name', 'title' => trans('admin.userName')],
            ['name' => 'email', 'data' => 'email', 'title' => trans('admin.userEmail')],
            ['name' => 'level', 'data' => 'level', 'title' => trans('admin.level')],
